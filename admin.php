...
<button class="navbutton" onclick="location.href = 'index.php'"><strong>HOME</strong></button>
		...
		<center style="  margin-top: 100px;">
         ...
         <p style="color:#fff;font-size:20px;" >Enter your Username and Password to Begin</p>
			...
			<form   action="adminlogin.php" method="post" style=" size:20px; text-align: center; width:35%; height:55%; background-color:#fff;" >
				<br>
				<br>
			...
			<a href="adminforgot.php" style=" text-decoration:none;font-size:15px; margin-left:180px;"><strong>Forgot Password? </a>
			<br><br>
			<center>
			          
					<input type="submit" name="check"  class="button" style="background-color:#eee;" value="LOGIN" />
