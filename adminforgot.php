...
<style>
body {
    background-image: url("images/adminforgot.jpg");
...
<body>
<button class="navbutton" onclick="location.href = 'admin.php'"><strong>BACK</strong></button>
<?php
session_start();
...
{   $username=mysql_real_escape_string($_POST['username']);
	...
	if($newPass==$confirmPass )
		if(mysql_query("UPDATE login SET password='$newPass' WHERE username='$username'"))
		{
			?>
...
<form  method="post" style="size:15px; text-align:center;  margin-bottom:50px; width:40%; height:70%; background-color:#fff;"><br><br>
...
<br>
			<center>
					<button type="submit" name="btn-update" class="button" style="background-color:#eee;">UPDATE</button>
					<br><br>
				</form>
</center>
</center>
